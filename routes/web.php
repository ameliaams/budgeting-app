...
Route::post('/keluar/delete', [App\Http\Controllers\laporanTransaksiKeluarController::class, 'deletenew'])->name('keluar.delete');
...
//Route::post('/masuk/delete', [App\Http\Controllers\laporanTransaksiMasukController::class, 'hapusAll'])->name('masuk.delete');
Route::get('/masuk/delete/{id}', [App\Http\Controllers\laporanTransaksiMasukController::class, 'hapusAll'])->name('masuk.delete');
